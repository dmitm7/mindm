...
public class FirstLvlActivity extends AppCompatActivity implements GestureDetector.OnGestureListener {
    private ImageView back, player, finish, walls;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set();
        this.gestureDetector = new GestureDetector(FirstLvlActivity.this, this);
    }

    public void set() {
        back = findViewById(R.id.backLvl1);
        player = findViewById(R.id.player1);
        finish = findViewById(R.id.finish1);
        walls = findViewById(R.id.walls1);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FirstLvlActivity.this, LevelsActivity.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Arrays.equals(test, xy)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(FirstLvlActivity.this);
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() { // Кнопка ОК
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(FirstLvlActivity.this, SecondLvlActivity.class);
                            startActivity(intent);
                        }
                    });
