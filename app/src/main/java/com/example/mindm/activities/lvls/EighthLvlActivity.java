...
public class EighthLvlActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eighth_lvl);
        set();
        this.gestureDetector = new GestureDetector(EighthLvlActivity.this, this);
    }

    public void set() {
        back = findViewById(R.id.backLvl8);
        player = findViewById(R.id.player8);
        finish = findViewById(R.id.finish8);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EighthLvlActivity.this, LevelsActivity.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Arrays.equals(test, xy)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EighthLvlActivity.this);
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() { // Кнопка ОК
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(EighthLvlActivity.this, NinthLvlActivity.class);
                            startActivity(intent);
                        }
                    });
