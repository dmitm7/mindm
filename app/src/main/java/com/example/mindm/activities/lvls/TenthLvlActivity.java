...
public class TenthLvlActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_lvl);
        set();
        this.gestureDetector = new GestureDetector(TenthLvlActivity.this, this);
    }

    public void set() {
        back = findViewById(R.id.backLvl10);
        player = findViewById(R.id.player10);
        finish = findViewById(R.id.finish10);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TenthLvlActivity.this, LevelsActivity.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Arrays.equals(test, xy)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(TenthLvlActivity.this);
