...
public class SeventhLvlActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set();
        this.gestureDetector = new GestureDetector(SeventhLvlActivity.this, this);
    }

    public void set() {
        back = findViewById(R.id.backLvl7);
        player = findViewById(R.id.player7);
        finish = findViewById(R.id.finish7);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SeventhLvlActivity.this, LevelsActivity.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Arrays.equals(test, xy)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(SeventhLvlActivity.this);
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() { // Кнопка ОК
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(SeventhLvlActivity.this, EighthLvlActivity.class);
                            startActivity(intent);
                        }
                    });
