...
public class FourthLvlActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set();
        this.gestureDetector = new GestureDetector(FourthLvlActivity.this, this);
    }

    public void set() {
        back = findViewById(R.id.backLvl4);
        player = findViewById(R.id.player4);
        finish = findViewById(R.id.finish4);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FourthLvlActivity.this, LevelsActivity.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Arrays.equals(test, xy)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(FourthLvlActivity.this);
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() { // Кнопка ОК
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(FourthLvlActivity.this, FifthLvlActivity.class);
                            startActivity(intent);
                        }
                    });
