...
public class NinthLvlActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ninth_lvl);
        set();
        this.gestureDetector = new GestureDetector(NinthLvlActivity.this, this);
    }

    public void set() {
        back = findViewById(R.id.backLvl9);
        player = findViewById(R.id.player9);
        finish = findViewById(R.id.finish9);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(NinthLvlActivity.this, LevelsActivity.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Arrays.equals(test, xy)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(NinthLvlActivity.this);
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() { // Кнопка ОК
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(NinthLvlActivity.this, TenthLvlActivity.class);
                            startActivity(intent);
                        }
                    });
