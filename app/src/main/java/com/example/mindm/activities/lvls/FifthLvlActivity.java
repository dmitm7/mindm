...
public class FifthLvlActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set();
        this.gestureDetector = new GestureDetector(FifthLvlActivity.this, this);
    }

    public void set() {
        back = findViewById(R.id.backLvl5);
        player = findViewById(R.id.player5);
        finish = findViewById(R.id.finish5);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FifthLvlActivity.this, LevelsActivity.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Arrays.equals(test, xy)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(FifthLvlActivity.this);
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() { // Кнопка ОК
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(FifthLvlActivity.this, SixthLvlActivity.class);
                            startActivity(intent);
                        }
                    });
